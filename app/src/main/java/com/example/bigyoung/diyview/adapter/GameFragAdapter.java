...
public class GameFragAdapter extends SuperBaseAdapter<List<ItemBean>> {
    ...
    public GameFragAdapter(Context context, GameFragProtocol baseProtocol, List<String> pictures) {
        this(context, null, baseProtocol, pictures);
    }

    public GameFragAdapter(Context context, List<ItemBean> mItemList, GameFragProtocol baseProtocol, List<String> pictures) {
    ...
    protected void fixHeadViewHolder(RecyclerView.ViewHolder holder) {
      /*  ViewHolderHead headHolder = (ViewHolderHead) holder;
        headHolder.mEmptyHead.setVisibility(View.GONE);*/
    }
